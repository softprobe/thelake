...
> **Legacy 2025 strategic vision.** Iceberg positioning and roadmap statements
> below are historical. Current runtime goals are in [`../goals.md`](../goals.md);
> current storage architecture is defined by
> [ADR-014](../decision_log.md#adr-014-ducklake-is-the-only-runtime-table-format).

**Company**: Softprobe
**Date**: 2025-12-31
**Status**: Historical strategic vision
...
- [Design Document](design-iceberg-buffer-wal.md) - Technical architecture and implementation
- [Storage Design Brainstorm](storage-design-iceberg.md) - HTTP body storage and indexing options
- OpenSpec Proposal (historical path: `../../openspec/changes/add-iceberg-otlp-migration/proposal.md`) - Iceberg migration plan
