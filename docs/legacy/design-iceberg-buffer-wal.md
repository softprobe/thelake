...
> **Historical / pre-DuckLake.** Durable storage is now **DuckLake**. See
...
> **See Also**: [Softprobe Business Vision & Strategic Goals](goals-2025-iceberg.md) - Understand the broader business context and long-term vision for this project.
...
**Rationale** (See [Storage Design Analysis](storage-design-iceberg.md#is-iceberg-the-right-foundation)):
...
**Design Decision** (See [Storage Design](storage-design-iceberg.md#executive-decision--analysis)):
...
**Documentation**: See the [legacy Grafana/Iceberg guide](grafana-iceberg-guide.md)
...
See tasks.md (historical path: `../../openspec/changes/add-iceberg-otlp-migration/tasks.md`) for current status.
...
- **Business Vision**: [Softprobe Strategic Goals](goals-2025-iceberg.md) - Long-term vision and business context
- **Storage Design**: [HTTP Body Storage & Business Attribute Indexing](storage-design-iceberg.md) - Detailed design options
- **OpenTelemetry Protocol**: https://opentelemetry.io/docs/specs/otlp/
- **Apache Iceberg**: https://iceberg.apache.org/docs/latest/
- **Iceberg Rust**: https://github.com/apache/iceberg-rust
- **OpenSpec Proposal**: openspec/changes/add-iceberg-otlp-migration/proposal.md (historical path: `../../openspec/changes/add-iceberg-otlp-migration/proposal.md`)
- **OpenSpec Tasks**: openspec/changes/add-iceberg-otlp-migration/tasks.md (historical path: `../../openspec/changes/add-iceberg-otlp-migration/tasks.md`)
