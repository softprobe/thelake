...
> **Legacy Iceberg-era decision log.** This file preserves superseded
> decisions and pending questions as they were recorded. The canonical current
> decisions are in [`../decision_log.md`](../decision_log.md).
...
- [Storage Design Analysis](storage-design-iceberg.md#is-iceberg-the-right-foundation)
- [Design Document Section 4](design-iceberg-buffer-wal.md#4-storage-platform-decision)
...
- [Design Document Section 4.0.1](design-iceberg-buffer-wal.md#401-object-storage-cloudflare-r2)
...
- [Storage Design Section on Separation](storage-design-iceberg.md#storage-separation-table-level-vs-column-level)
- [Design Document Section 5.1](design-iceberg-buffer-wal.md#51-table-traces)
...
- [Storage Design Options 1-4](storage-design-iceberg.md#design-options-for-our-system)
- [Storage Design Decision](storage-design-iceberg.md#business-attribute-indexing-final-decision)
- OpenSpec Tasks Section 6 (historical path: `../../openspec/changes/add-iceberg-otlp-migration/tasks.md#6-business-attribute-indexing-sp-convention`)
...
- [Storage Design Analysis](storage-design-iceberg.md#storage-schema-considerations)
- [Design Document Section 5.1](design-iceberg-buffer-wal.md#51-table-traces)
...
- OpenSpec Tasks Section 5 (historical path: `../../openspec/changes/add-iceberg-otlp-migration/tasks.md#5-http-body-storage--business-attribute-indexing`)

---

## DuckLake migration note

DuckLake superseded ADR-001 after this Iceberg-era log was written. The
canonical decision and current consequences are maintained only in
[current ADR-014](../decision_log.md#adr-014-ducklake-is-the-only-runtime-table-format).
